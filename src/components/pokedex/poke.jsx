...
import "animate.css";
import RequestPokes from "./request/RequestPokes";
...
export const Poke = () => {
  ...
  useEffect(() => {
    dispatch({
      type: "FNC-MODALLOADING",
      payload: true,
    });
    RequestPokes(store.value_req).then((res) => {
      dispatch({
        type: "FNC-INITDATA",
        payload: res,
      });
  ...
  const CustomDispatch = (action, payload = 0) => {
    console.log("value", store.value_req);
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <div className="grid items-center grid-cols-8 my-12 -mt-14 w-full h-80 border-double rounded-full border-8 border-x-slate-800 bg-teal-100 bg-opacity-70">
          ...
          <div className="flex flex-col items-center justify-center col-span-2">
            <div className="relative flex items-center justify-center basis-4/12 ">
              <div className="flex absolute items-center justify-center font-medium bg-sky-700 rounded-full border-4 border-double boder-8 border-y-black -top-10 w-40 h-10 text-cyan-100 z-10">
                <SwitchTransition>
                  <CSSTransition
                    classNames="fade"
                    key={store.nombre}
