...
export const storeReducer = (store, action) => {
  // RequestPokes(0).then((res) => {
  //   console.log("ress", res);
  // });
  // const onRequestPokes = useCallback(async () => {
  //   const reqPokes = await RequestPokes(store.value_req);
  //   return
  // }, [])();
  ...
  switch (action.type) {
    ...
    case types.comparea:
      if (store.hp_primary > store.hp_second) {
        console.log("hp es mayor");
      }
      return {
        ...store,
