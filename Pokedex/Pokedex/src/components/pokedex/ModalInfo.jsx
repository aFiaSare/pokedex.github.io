      ...
      <div className=" flex items-center justify-center w-screen h-screen z-10">
        <div className="absolute h-80 items-center justify-center top-5 left-5">
          <img
            ...
            alt=""
            className="h-20 w-24 border-dotted border-8 border-slate-700"
          />
        </div>
        <div className="flex bg-teal-100 bg-opacity-70 w-200 h-128 rounded-l-full rounded border-8 border-double border-x-stone-400 border-y-black">
          ...
          <div className="flex flex-col basis-1/2">
            ...
            <div className="flex flex-row basis-4/12">
              <div className="flex basis-1/2 items-center justify-center bg-green-100 border-double border-4 border-slate-800 rounded-full m-1">
